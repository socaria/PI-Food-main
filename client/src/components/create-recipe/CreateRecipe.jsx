...
export default function CreateRecipe() {
    ...
    const handleChange = (e) => {
        ...
        console.log("🚀 ~ file: CreateRecipe.jsx ~ line 59 ~ handleChange ~ input", input)
        ...
        <>
            ...
            <div className="create-recipe__container">
                ...
                <form onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <br></br>
                    <button
                        className="create-recipe__button-functional"
                    ...
                    {input.title && input.summary && !error.title && !error.summary && !error.healthScore && !error.image?
                        <button className="create-recipe__button-functional" disabled={false} type="submit">Create recipe</button>
