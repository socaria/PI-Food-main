...
import {getDiets, getRecipes, editRecipe, getRecipeDetail} from "../../actions";
 ...
 const EditRecipe = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (input.title && !error.title && !error.summary && !error.healthScore && !error.image) {
            dispatch(editRecipe(recipeDetail.id, input));
            alert('The recipe was modified successfully!');
            window.location.assign(`/recipes/${recipeDetail.id}`);
        }
    };
        ...
        <>
            ...
            <div className="edit-recipe__container">
                ...
                <form onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <br></br>
                    <button
                        className="edit-recipe__button-functional"
                    ...
                    {input.title && input.summary && !error.title && !error.summary && !error.healthScore && !error.image ?
                        <button className="edit-recipe__button-functional" disabled={false} type="submit">Save changes</button>
